        ...
        <div className={s.discussion__container}>
            <div className={s.discussion}>
                ...
                <div className={s.discussion__buttons}>
                    <button className={`${s.discussion__button} ${s.discussion__button_margin_10px}`}>
                        <svg className={s.call__svg} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button className={s.discussion__button}>
                        <svg className={s.video__svg} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
